const DAY26 = {
    ...
    description: `
    Today we'll begin by looking at so-called Perlin noise, which is a nice way to generate gradient noise patterns.

    Then, we'll We'll continue our exploration of shaders, and use them with sound to make nifty visualizations that re-arrange 
    the pixels of an image into ripples.

    And, we'll take a little look at what we can do with shaders, by adding a generative wood pattern to our model.   
    ...
    And, I'll help anyone who needs help with their projects!
    `,
    videos: [
        {
            linkText: '',
    ...
    techLinks: [
        {
            linkText: 'https://genekogan.com/code/p5js-perlin-noise/',
            linkSrc: 'an intro to perlin noise',
        },
        {
