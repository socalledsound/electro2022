const DAY22 = {
    ...
    And, by lately, I mean, for the last fifty years or so.  
    Today we'll start to talk about XR in all of it's various forms: interactive mulitmedia ad campaigns, 
